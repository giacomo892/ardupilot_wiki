...
- Set :ref:`SERIAL5_OPTIONS <SERIAL5_OPTIONS>` to 4 to enable half-duplex which SmartAudio requires. Depending on your video trasmitter it might be required to enable the TX_PullDown option. So 68 would be the correct value.
